document.addEventListener('DOMContentLoaded', function() {
    ...
    // Image slider and size button toggle
    const productImages = document.querySelectorAll(".productImages img"); // selecting all image thumbs
    const productImageSlide = document.querySelector(".imageSlider"); // seclecting image slider element
    ...
    // toggle size buttons
    const sizeBtns = document.querySelectorAll('.sizeRadioBtn'); // selecting size buttons
